...
Util.prototype.setCssVariables = function () {
  ...
  sheet.setAttribute('class','btn-style');
  ...
  str += "--rectangle:"+this.curTheme().rectangle+";"
  str += "--hexagon:"+this.curTheme().hexagon+";";
  str += "--circle:"+this.curTheme().circle+";";

  str += "--traingle:"+this.curTheme().traingle+";"
  str += "--square:"+this.curTheme().square+";";
  str += "--decagon:"+this.curTheme().decagon+";";
  ...
  sheet.innerHTML = str;
  // document.getElementById("btn-style").remove();
  var cls=document.getElementsByClassName("btn-style");
  if(cls.length>0)
  {
    cls[0].remove();
  }
